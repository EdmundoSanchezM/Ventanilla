        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            if(!sesion.isNew()){
                ...
                out.print("<li class='nav-item'> <a class='nav-link js-scroll-trigger' href='Ventanilla/Ventanilla.jsp'>Solicitud de Tramite</a> </li>"); 
                out.print("<li class='nav-item'> <a class='nav-link js-scroll-trigger' >Consulta de Tramites Solicitados</a> </li>"); 
                out.print("<li class='nav-item'> <a class='nav-link js-scroll-trigger' href='PVV.jsp'>Cancelación de Tramite</a> </li>"); 
                out.print("<li class='nav-item'> <a class='nav-link js-scroll-trigger' >Ayuda en linea </a> </li>"); 
                out.print("<li class='nav-item'> <a class='nav-link js-scroll-trigger' href='index.jsp'>Inicio</a> </li>"); 
